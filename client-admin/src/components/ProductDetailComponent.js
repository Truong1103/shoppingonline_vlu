          ...
          <table>
            <tbody>
              ...
              <tr>
                <td></td>
                <td>
                    <input type="submit" className="btn-addnew" value="ADD NEW" onClick={(e) => this.btnAddClick(e)} />
                    <input type="submit" className="btn-update" value="UPDATE" onClick={(e) => this.btnUpdateClick(e)} />
                    <input type="submit" className="btn-delete" value="DELETE" onClick={(e) => this.btnDeleteClick(e)} />
                </td>
              </tr>
              <tr>
