...
class Order extends Component {
      ...
      return (
        <tr key={item._id} className="datatable" onClick={() => this.trItemClick(item)}>
          ...
          <td>
            {item.status === 'PENDING' ?
              <div>
                <span className="link" onClick={(e) => this.lnkApproveClick(e, item._id)}>
                  APPROVE
                </span>
                {' || '}
                <span className="link" onClick={(e) => this.lnkCancelClick(e, item._id)}>
                  CANCEL
                </span>
              </div>
              : <div />
  ...
  // FIXED: event phải đứng trước id
